...
translate([44.750000,16.215000,0.800000])rotate([0,0,90.000000])m0(part,hole,block,casetop); // RevK:C_0603_ C_0603_1608Metric (back)
translate([5.500000,5.500000,0.800000])rotate([0,0,180.000000])m1(part,hole,block,casetop); // U2 (back)
translate([24.250000,9.150000,0.800000])m2(part,hole,block,casetop,3); // J3 (back)
translate([26.050000,28.700000,0.800000])rotate([0,0,90.000000])m3(part,hole,block,casetop); // RevK:C_0402 C_0402_1005Metric (back)
translate([47.250000,12.915000,0.800000])rotate([-0.000000,-0.000000,-90.000000])m4(part,hole,block,casetop); // RevK:L_4x4_ TYA4020 (back)
translate([35.250000,4.400000,0.800000])translate([0.000000,-1.050000,0.000000])rotate([90.000000,-0.000000,-0.000000])m5(part,hole,block,casetop); // RevK:USC16-TR CSP-USC16-TR (back)
translate([35.250000,24.000000,0.800000])m6(part,hole,block,casetop); // U1 (back)
translate([49.250000,35.250000,0.800000])rotate([0,0,-45.000000])m7(part,hole,block,casetop); // D4 (back)
translate([47.250000,15.515000,0.800000])m0(part,hole,block,casetop); // RevK:C_0603_ C_0603_1608Metric (back)
translate([49.750000,16.215000,0.800000])rotate([0,0,90.000000])m0(part,hole,block,casetop); // RevK:C_0603_ C_0603_1608Metric (back)
// Missing model U7.1 LX5563LL-TR
// Missing model U8.1 VEML3235SL
translate([37.250000,9.000000,0.800000])m8(part,hole,block,casetop); // RevK:R_0402 R_0402_1005Metric (back)
translate([53.600000,30.600000,0.800000])rotate([0,0,180.000000])m3(part,hole,block,casetop); // RevK:C_0402 C_0402_1005Metric (back)
translate([47.250000,19.415000,0.800000])m8(part,hole,block,casetop); // RevK:R_0402 R_0402_1005Metric (back)
translate([26.850000,28.700000,0.800000])rotate([0,0,90.000000])m3(part,hole,block,casetop); // RevK:C_0402 C_0402_1005Metric (back)
translate([44.450000,29.400000,0.800000])rotate([0,0,-90.000000])m3(part,hole,block,casetop); // RevK:C_0402 C_0402_1005Metric (back)
translate([43.650000,29.400000,0.800000])rotate([0,0,90.000000])m8(part,hole,block,casetop); // RevK:R_0402 R_0402_1005Metric (back)
translate([33.450000,9.000000,0.800000])rotate([0,0,180.000000])m8(part,hole,block,casetop); // RevK:R_0402 R_0402_1005Metric (back)
translate([45.450000,19.415000,0.800000])m8(part,hole,block,casetop); // RevK:R_0402 R_0402_1005Metric (back)
translate([46.000000,9.150000,0.800000])m9(part,hole,block,casetop,2); // J2 (back)
translate([49.050000,19.415000,0.800000])m8(part,hole,block,casetop); // RevK:R_0402 R_0402_1005Metric (back)
translate([47.250000,17.515000,0.800000])m10(part,hole,block,casetop); // RevK:SOT-23-6-MD8942 SOT-23-6 (back)
translate([39.450000,9.700000,0.800000])rotate([0,0,-90.000000])m11(part,hole,block,casetop); // D3 (back)
translate([25.500000,11.400000,0.800000])m8(part,hole,block,casetop); // RevK:R_0402 R_0402_1005Metric (back)

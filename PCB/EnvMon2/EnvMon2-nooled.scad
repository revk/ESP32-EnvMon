...
translate([44.425000,13.250000,1.600000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([5.500000,5.500000,1.600000])rotate([0,0,180.000000])m3(pushed,hulled); // RevK:SCD41 SCD41 (back)
translate([24.250000,9.150000,1.600000])m5(pushed,hulled,3); // RevK:PTSM-HH-3-RA PTSM-HH-3-RA (back)
translate([52.200000,8.600000,1.600000])rotate([0,0,180.000000])m8(pushed,hulled); // RevK:D_1206 D_1206_3216Metric (back)
translate([48.750000,15.950000,1.600000])m11(pushed,hulled); // RevK:C_0805_ C_0805_2012Metric (back)
translate([20.600000,36.200000,1.600000])translate([0.000000,-0.750000,0.750000])rotate([-90.000000,-0.000000,-0.000000])m13(pushed,hulled); // RevK:VEML3235SL-RA VEML3235SL (back)
translate([35.250000,4.400000,1.600000])translate([0.000000,-1.050000,0.000000])rotate([90.000000,-0.000000,-0.000000])m15(pushed,hulled); // RevK:USC16-TR CSP-USC16-TR (back)
translate([44.425000,12.000000,1.600000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([40.050000,11.275000,1.600000])rotate([0,0,90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([45.200000,16.800000,1.600000])rotate([0,0,90.000000])rotate([-0.000000,-0.000000,-90.000000])m17(pushed,hulled); // RevK:SOT-23-Thin-6-Reg SOT-23-6 (back)
translate([49.900000,30.400000,1.600000])rotate([0,0,-90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([45.200000,20.700000,1.600000])rotate([0,0,90.000000])rotate([-0.000000,-0.000000,-90.000000])m19(pushed,hulled); // RevK:L_4x4_ TYA4020 (back)
translate([37.600000,8.200000,1.600000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([45.450000,14.700000,1.600000])m22(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric (back)
translate([48.750000,22.200000,1.600000])m11(pushed,hulled); // RevK:C_0805_ C_0805_2012Metric (back)
translate([34.600000,10.800000,1.600000])rotate([0,0,90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([51.000000,30.400000,1.600000])rotate([0,0,-90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([35.800000,10.800000,1.600000])rotate([0,0,90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([48.370000,19.080000,1.600000])rotate([0,0,90.000000])m8(pushed,hulled); // RevK:D_1206 D_1206_3216Metric (back)
translate([49.900000,35.825000,1.600000])translate([0.000000,-0.100000,0.400000])rotate([-90.000000,-0.000000,-0.000000])m26(pushed,hulled); // RevK:MHS190RGBCT LED_0603_1608Metric (back)
translate([32.800000,8.200000,1.600000])rotate([0,0,180.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([38.850000,11.275000,1.600000])rotate([0,0,-90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([27.250000,27.675000,1.600000])rotate([0,0,-90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([46.000000,9.150000,1.600000])m29(pushed,hulled,2); // RevK:PTSM-HH-2-RA-W PTSM-HH-2-RA-W (back)
translate([35.250000,26.006750,1.600000])m30(pushed,hulled); // RevK:ESP32-PICO-MINI-02 ESP32-PICO-MINI-02 (back)
translate([41.250000,11.275000,1.600000])rotate([0,0,-90.000000])m22(pushed,hulled); // RevK:C_0603_ C_0603_1608Metric (back)
translate([25.500000,11.400000,1.600000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([48.800000,30.400000,1.600000])rotate([0,0,-90.000000])m2(pushed,hulled); // RevK:R_0603 R_0603_1608Metric (back)
translate([35.050000,14.750000,1.600000])m33(pushed,hulled); // RevK:QFN-20-1EP_4x4mm_P0.5mm_EP2.5x2.5mm QFN-20-1EP_4x4mm_P0.5mm_EP2.5x2.5mm (back)
translate([49.000000,12.750000,1.600000])rotate([0,0,-90.000000])m8(pushed,hulled); // RevK:D_1206 D_1206_3216Metric (back)
}
